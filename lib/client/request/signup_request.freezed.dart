...
abstract class $SignupRequestCopyWith<$Res> {
  ...
  @useResult
  $Res call({String nickname, String email, String token});
}
...
class _$_SignupRequest with DiagnosticableTreeMixin implements _SignupRequest {
  const _$_SignupRequest(
      {required this.nickname, required this.email, required this.token});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'SignupRequest(nickname: $nickname, email: $email, token: $token)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, nickname, email, token);
...
abstract class _SignupRequest implements SignupRequest {
  const factory _SignupRequest(
      ...
      required final String token}) = _$_SignupRequest;
